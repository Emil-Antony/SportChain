    ...
    useEffect(() => {
      ...
      return (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-70 backdrop-blur-sm z-50">
            <div className="bg-gray-900 p-8 rounded-xl shadow-2xl w-96 text-center relative border border-gray-700">
                <button
                    onClick={onClose}
                ...
                <div className="flex flex-col items-center">
                    <div className="mb-6 p-4 bg-gray-800 rounded-full">
                        <svg className="w-10 h-10 text-purple-500 animate-pulse" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {!requestReceived ? (
                        <>
                            <h2 className="text-xl font-semibold mb-3 text-white">Waiting for mobile...</h2>
                            <p className="text-gray-400 mb-6">Please open the app on your device to connect</p>
                        ...
                        <>
                            <h2 className="text-xl font-semibold mb-3 text-white">Connection Request</h2>
                            <p className="text-gray-400 mb-4">A device wants to connect:</p>
